    ...
    return (
        <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden bg-[#020817] text-white">
            ...
            <div className="container relative mx-auto px-4 md:px-6 text-center">
                <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 max-w-5xl mx-auto bg-clip-text text-transparent bg-gradient-to-b from-white to-white/70 leading-[1.1]">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
                    <Button
                        size="lg"
                        className="w-full sm:w-auto h-12 px-8 rounded-full bg-blue-600 hover:bg-blue-700 text-white font-medium text-base shadow-[0_0_20px_rgba(37,99,235,0.3)] transition-all hover:scale-105"
                    >
                    ...
                    <Button
                        size="lg"
                        variant="outline"
                        className="w-full sm:w-auto h-12 px-8 rounded-full bg-white/5 border-white/10 text-white hover:bg-white/10 font-medium text-base backdrop-blur-sm transition-all hover:scale-105"
                    >
                        Get in Touch
                    </Button>
                </div>
